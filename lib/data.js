...
// NOTE: Real partner SVG assets are not in this repo. Until partner SVGs
// are dropped into /public/assets/Brand Logos SVG/, we render styled
// TEXT wordmarks instead of falsely-mapped foreign SVGs (the previous
// version pointed Coursera/Dale Carnegie/IC3 etc. at ace_tate/anwb/kfc/
// netflix logos — a direct false-claim violation). To swap back to <img>
// once real SVGs land: replace each `wordmark` field with `src: '/assets/
// Brand Logos SVG/<filename>.svg'` and update BrandStrip.jsx accordingly.
export const brands = [
  { name: 'Coursera', wordmark: 'Coursera' },
  { name: 'Dale Carnegie', wordmark: 'Dale Carnegie' },
  { name: 'IC3', wordmark: 'IC3' },
  { name: 'HubSpot Academy', wordmark: 'HubSpot Academy' },
  { name: 'Cisco NetAcad', wordmark: 'Cisco NetAcad' },
  { name: 'ITIDA', wordmark: 'ITIDA' },
  { name: 'AMIDEAST', wordmark: 'AMIDEAST' },
  { name: 'Google Cloud', wordmark: 'Google Cloud' },
];
...
// Each card: Arabic title (primary), English subtitle (accent), Arabic services.
// Sticker key must match a file in /public/assets/Card-Sticker SVG/sticker-<key>.svg
