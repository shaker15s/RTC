...
export default function VimeoHero() {
  ...
  // Hero text entrance — runs once on mount (above-the-fold, no scroll trigger).
  useEffect(() => {
        ...
        <div className="home-header__title">
            ...
            <span className="vimeo-hero__word vimeo-hero__word--ar is--relative">
              ...
              <div className="home-header__smiley" aria-hidden="true">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M5 19c2-5 5-9 10-11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              </div>
            </span>
          ...
          <div className="vimeo-hero__subtitle-block">
            ...
            <div className="vimeo-hero__cta-row">
              <a
                className="vimeo-hero__cta vimeo-hero__cta--primary"
                href="https://www.facebook.com/RTC.Nasrcity"
                target="_blank"
                rel="noreferrer noopener"
              >
                <span className="vimeo-hero__cta-text">View This Month&rsquo;s Schedule</span>
                <span className="vimeo-hero__cta-arrow" aria-hidden="true">
              ...
              <a
                className="vimeo-hero__cta vimeo-hero__cta--secondary"
                href="https://wa.me/201115997937"
                target="_blank"
                rel="noreferrer noopener"
              >
                <span className="vimeo-hero__cta-text">WhatsApp RTC</span>
              </a>
            </div>
          </div>
        </div>
