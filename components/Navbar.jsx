...
export default function Navbar() {
  useEffect(() => {
    ...
    const cleanups = [];
    const logoRtc = document.querySelector('.logo-rtc');
    if (logoRtc) cleanups.push(initWiggle(logoRtc, WIGGLE_CONFIG.logoRtc));
    ...
    if (navRight && waBox) {
      ...
      const onEnterRight = () => {
        ...
        showOverlay();
        if (waSvgPath) gsap.to(waSvgPath, { fill: '#0e6634ff', duration: 0.3 });
        gsap.set(waBox, { visibility: 'visible' });
        gsap.fromTo(waBox, { scale: 0, opacity: 0 }, { scale: 1, opacity: 1, duration: 0.8, ease: 'expo.out' });
    ...
    <>
      ...
      <nav className="navbar">
        <div className="nav-left" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
          <div className="nav-hover-trigger">
            <div className="logo-work-container">
              ...
              <span className="logo-work-text">Tracks</span>
            </div>
              ...
              <div className="nav-popout-inner">
                <div className="nav-work-item">
                  <div className="nav-work-item__img-wrap">
                    <div className="nav-work-item__img nav-work-item__placeholder nav-work-item__placeholder--engineering" aria-hidden="true">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="48" height="48">
                        <path d="M12 2L2 7v10c0 5 4 9 10 9s10-4 10-9V7l-10-5z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/>
                        <path d="M9 12l2 2 4-4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                  </div>
                  <div className="nav-work-item__text">
                    <span className="nav-work-badge badge-maroon">Engineering</span>
                    <h4 className="nav-work-title">PLC, AutoCAD, electrical circuits, mechatronics, maintenance</h4>
                  </div>
                </div>
                <div className="nav-work-item">
                  <div className="nav-work-item__img-wrap">
                    <div className="nav-work-item__img nav-work-item__placeholder nav-work-item__placeholder--computer" aria-hidden="true">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="48" height="48">
                  ...
                  <div className="nav-work-item__text">
                    <span className="nav-work-badge badge-pink">Computer</span>
                    <h4 className="nav-work-title">Web dev, data analysis, IC3, cybersecurity, Python</h4>
                  </div>
                </div>
                <div className="nav-work-item">
                  <div className="nav-work-item__img-wrap">
                    <div className="nav-work-item__img nav-work-item__placeholder nav-work-item__placeholder--languages" aria-hidden="true">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="48" height="48">
                        <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.6"/>
                        <path d="M3 12h18M12 3a13 13 0 010 18M12 3a13 13 0 000 18" stroke="currentColor" strokeWidth="1.4"/>
                      </svg>
                    </div>
                  </div>
                  <div className="nav-work-item__text">
                    <span className="nav-work-badge badge-pink">Languages</span>
                    <h4 className="nav-work-title">English, French A1-A2, German A1, Spanish, IELTS</h4>
                  </div>
                </div>
                <a href="#service-cards" className="nav-work-btn"><span className="nav-work-btn__text">All Courses</span></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="nav-center" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
          <span className="logo-rtc" role="img" aria-label="RTC Nasr City — Resala">
            <span className="logo-rtc__mark">RTC</span>
            <span className="logo-rtc__sub">Resala</span>
          </span>
        </div>
          ...
          <div className="nav-hover-trigger">
            ...
            <div className="nav-popout nav-wa-box">
              <div className="nav-popout-inner">
                ...
                <h4 className="nav-wa-title">Chat on WhatsApp</h4>
                <p className="nav-wa-desc">Scan the code or tap the button to connect directly via WhatsApp.</p>
                <a href="https://wa.me/201115997937" className="nav-wa-link">
                  <span className="nav-wa-link-text">0111 599 7937</span>
